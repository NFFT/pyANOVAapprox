...
def b_spline_6(x):
    ...
    if 0.0 <= x < 1.0 / 6:
        ...
        return C_6 * (-237 / 10 + 351 * x - 2052 * x**2 + 5832 * x**3 - 7776 * x**4 + 3888 * x**5)
    elif 0.5 <= x < 4.0 / 6:
        return C_6 * (2193 / 10 + 7668 * x**2 - 2079 * x + 11664 * x**4 - 13608 * x**3 - 3888 * x**5)
    elif 4.0 / 6 <= x < 5.0 / 6:
        return C_6 * (-5487 / 10 + 3681 * x - 9612 * x**2 + 12312 * x**3 - 7776 * x**4 + 1944 * x**5)
    elif 5.0 / 6 <= x < 1.0:
        return C_6 * (1944 / 5 - 1944 * x + 3888 * x**2 - 3888 * x**3 + 1944 * x**4 - (1944 / 5) * x**5)
    else:
