...
def get_variances(a, lam = None, Dict = False):
    ...
    if isinstance(lam, float):            
        return get_variance(a = a, lam = lam, Dict = Dict) #get_variances(a::approx, λ::Float64; dict::Bool=false,)::Union{Vector{Float64},Dict{Vector{Int},Float64}}

    elif lam == None:  #get_variances( a::approx; dict::Bool = false )::Dict{Float64,Union{Vector{Float64},Dict{Vector{Int},Float64}}}
...
def get_GSI(a, lam = None, Dict = False):
    ...
    if lam is not None:  #get_GSI(a::approx, λ::Float64; dict::Bool = false,)::Union{Vector{Float64},Dict{Vector{Int},Float64}}
...
def get_AttributeRanking(a, lam = None):
    ...
    """
    if lam == None:    #get_AttributeRanking( a::approx, λ::Float64 )::Dict{Float64,Vector{Float64}}
...
def get_ActiveSet(a, eps, lam = None):
    ...
    if lam == None:   #get_ActiveSet(a::approx, eps::Vector{Float64})::Dict{Float64,Vector{Vector{Int}}}
