...
def Rho1(x, m):
    ...
    result[x >= 1.5] = 1
    result[(x >= 0.5) & (x < 1.5)] = (
        5/6 + 9/8*x[(x >= 0.5) & (x < 1.5)] - 3/4*x[(x >= 0.5) & (x < 1.5)]**2
        + 1/6*x[(x >= 0.5) & (x < 1.5)]**3 - 19/48
    )
    result[(x >= -0.5) & (x < 0.5)] = (
        1/6 + 3/4*x[(x >= -0.5) & (x < 0.5)] - 1/3*x[(x >= -0.5) & (x < 0.5)]**3 + 1/3
    )
    result[(x >= -1.5) & (x < -0.5)] = (
        9/8*x[(x >= -1.5) & (x < -0.5)] + 3/4*x[(x >= -1.5) & (x < -0.5)]**2 +
        1/6*x[(x >= -1.5) & (x < -0.5)]**3 + 9/16
    )
    result[x < -1.5] = 0
    return result
