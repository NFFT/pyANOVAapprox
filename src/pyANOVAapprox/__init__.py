...
def approximate(a, lam=None, max_iter=50, weights=None, verbose=False, solver=None, tol=1e-8):
    a.approximate(lam, max_iter, weights, verbose, solver, tol)
def autoapproximate(a, settingnr = None, B = None, maxiter = 2, lmbda = 0.0, solver="lsqr", verbose=False, solver_max_iter=50, solver_weights=None, solver_verbose=False, solver_tol=1e-8):
